...
public class FenumFormatTranslator extends AbstractFormatTranslator<VecInt[], VecInt[], Integer> {
    /**
    ...
    public FenumFormatTranslator(Lattice lattice) {
        super(lattice);
        ...
        int curInt = 0;
        for (AnnotationMirror type : lattice.allAnnotations) {
    ...
    protected ConstraintEncoderFactory<VecInt[]> createConstraintEncoderFactory() {
        return new FenumConstraintEncoderFactory(lattice, typeToInt, this);
    }
