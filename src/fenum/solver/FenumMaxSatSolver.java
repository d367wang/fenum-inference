 ...
 *
 */
public class FenumMaxSatSolver extends Solver<FenumFormatTranslator> {
    ...
    public FenumMaxSatSolver(SolverEnvironment solverEnvironment, Collection<Slot> slots,
                             Collection<Constraint> constraints, FenumFormatTranslator formatTranslator, Lattice lattice) {
